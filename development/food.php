...
echo "<tr><TD colspan = 5 align=center>FOOD</td></tr>";
    foreach($res as $resvalue) {
        ...
        echo "<td><input name='food_pic_url[$food_price_id]' value='".$_SESSION["file"].$res1[count($res1)-1]['va_res_code']."/".$resvalue["va_food_pic_url"]."'></td>";
...
echo "<tr><TD colspan = 5 align=center>BEVERAGE</td></tr>";
    foreach($res2 as $res2value) {
        ...
        echo "<td><input name='bev_pic_url[$bev_price_id]' value='".$_SESSION["file"].$res1[count($res1)-1]['va_res_code']."/".$res2value["va_bev_pic_url"]."'></td>";
