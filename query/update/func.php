...
//define variable for query <<< 
    ...
    {    
        ...
        {    
        //define variable for query >>>       
            $user_order_data_1 = addslashes(!empty($_POST['user_order_data_1'])? $_POST['user_order_data_1'] : '');
            $user_order_data_2 = addslashes(!empty($_POST['user_order_data_2'])? $_POST['user_order_data_2'] : '');
        //define variable for query <<<
